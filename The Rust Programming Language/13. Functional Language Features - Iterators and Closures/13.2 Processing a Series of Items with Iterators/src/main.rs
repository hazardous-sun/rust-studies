fn priocessing_a_series_of_items_with_iterators() {
    /*
    ...
    into the vector to get a value, and incrementing the variable value in a loop until it reached
...
fn the_iterator_trait_and_the_next_trait() {
    /*
...
fn methods_that_consume_the_iterator() {
    /*
...
fn methods_that_produce_other_iterators() {
    ...
    In Listing 13-15, we collect the results of iterating over the iterator that’s returned from the
